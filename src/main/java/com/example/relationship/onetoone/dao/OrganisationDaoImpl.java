    ...
    public void update(Integer id, Object o) {
        ...
        if (o instanceof Employee) {
            ...
            if (editedemp != null) {
                ...
                editedemp.getDepartment().setName(((Employee) o).getDepartment().getName());
                entityManager.getTransaction().commit();
            } else {
                System.out.println("id not found");
            }
        } else if (o instanceof Department) {
            Department editeddep = findDepartmenOne(id);
            if (editeddep != null) {

                editeddep.setName(((Department) o).getName());

                editeddep.getEmployee().setEname(((Department) o).getEmployee().getEname());
                editeddep.getEmployee().setSalary(((Department) o).getEmployee().getSalary());
                editeddep.getEmployee().setDeg(((Department) o).getEmployee().getDeg());
